...
DATA_PATH = r"C:\Users\SW02\Downloads\Machine-Learning-Course-main\Machine-Learning-Course-main\ML-05-SVM\mini-proj\archive (1)\ECG_DATA\train"
OUTPUT_DIR = "outputs"
IMG_SIZE = 100
TEST_SIZE = 0.2
...
def main():
    ...
    print("--" * 30)
    print("SVM Image Recognition: ECG Heart Disease Classification")
    print("--" * 30)
